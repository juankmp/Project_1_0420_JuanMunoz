...
def main(args):
    ...
    mac.export_results('/home/usuario/Documentos/Ironhack/Project_1_0420_JuanMunoz/data/processed', df_all_raw_data,
                       data_country_scraping, data_jobs_api)
    ...
    time.sleep(3)
    mre.export_final_results('/home/usuario/Documentos/Ironhack/Project_1_0420_JuanMunoz/data/results',df_all_countries_agegroup,df_by_country_age_group,df_answer_for,df_answer_against,option_country)
    time.sleep(3)
